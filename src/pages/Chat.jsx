                ...
                <button key={chat._id} className={`chat-convo ${isActive ? "active" : ""}`} onClick={() => setActiveChatId(chat._id)}>
                  ...
                  <div className="chat-convo-info">
                    <div className="chat-convo-top">
                      <span className="chat-convo-name">{other?.firstName} {other?.lastName?.[0] ? `${other.lastName[0]}.` : ''}</span>
            ...
            <>
              ...
              <div className="chat-composer">
                <div className="chat-input-wrap">
                  <textarea ref={inputRef} className="chat-input" value={text} onChange={handleComposerChange} onKeyDown={handleKeyDown} placeholder="Type a message..." rows={1} />
                </div>
